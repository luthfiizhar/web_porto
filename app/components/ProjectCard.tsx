...
const ProjectCard = ({ imgUrl, title, description }: any) => {
  return (
    <div>
      <div
        ...
        <div className="overlay items-center justify-center absolute w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link
            href="/"
      ...
      <div className="text-white rounded-b-xl bg-[#181818] px-4 py-3">
